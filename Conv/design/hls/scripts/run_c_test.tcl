...
# Specified the list of functions comprising hierarchical blocks in this
# design.
# The directive must be set prior to "compiling" the design (must be in "new" or "analyze" state).
